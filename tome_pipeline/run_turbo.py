...
def multi_sampling(args, model, sampler, prompts, filter=None, profile_visible=False):
    """
    ...
    actual_iterations = 5 if profile_visible else len(prompts)
    ...
    for i in range(actual_iterations):
        ...
        samples, key_average = sample(model, sampler, H=512, W=512, seed=args.seed,
